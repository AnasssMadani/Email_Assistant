    ...
    phase === "post_reply"
      ...
      : (() => {
          ...
          return [
            ...
            "",
            "Regles:",
            "- Presente clairement des excuses pour le delai (ex: \"nous sommes",
            "  desoles du retard pris dans le traitement de votre demande\") — ce",
            "  n'est pas un simple rappel neutre, c'est un message qui reconnait",
            "  l'attente et rassure activement.",
            "- Rassure explicitement que le dossier reste une priorite et qu'une",
            "  reponse arrive tres prochainement (ex: \"nous revenons vers vous tres",
            "  rapidement\"), sans pour autant promettre un delai chiffre precis s'il",
            "  n'est pas confirme.",
            "- Rappelle brievement l'objet de la demande initiale — mais ce message ne",
            "  doit PAS ressembler a une redite de l'accuse de reception (fourni",
            "  ci-dessous): change l'angle et la formulation, ne recycle pas les",
            "  memes phrases. L'accuse annoncait la prise en compte; cette relance",
            "  reconnait l'attente et rassure sur le suivi actif.",
